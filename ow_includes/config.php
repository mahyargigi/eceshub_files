...
define('OW_URL_HOME', 'http://localhost/eceshub/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'mahyargigi');
define('OW_DB_PASSWORD', 'jPqf1Z1wJbUOkPbM');
define('OW_DB_NAME', 'eceshub_db');
...
define('OW_PASSWORD_SALT', 'rUSYx3dYnamapA5O');
