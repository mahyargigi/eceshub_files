...
class BASE_Members extends BASE_CMP_Users
{
    ...
    public function getFields( $userIdList )
    {
        ...
        $questionListResult = OW::getEventManager()->trigger(new OW_Event(IISEventManager::ON_BEFORE_USER_INFORMATION_RENDER, array('questionList' => $questionList, 'userIdList' => $userIdList)));
