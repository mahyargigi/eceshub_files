...
class IISGROUPSPLUS_MCMP_FileListWidget extends BASE_CLASS_Widget
{

    /**
     * IISGROUPSPLUS_MCMP_FileListWidget constructor.
    ...
    public function __construct( BASE_CLASS_WidgetParameter $params )
    {
        ...
        $this->setTemplate(OW::getPluginManager()->getPlugin('iisgroupsplus')->getMobileCmpViewDir() . 'file_list_widget.html');
    }
